...
class Settings():
    def __init__(self, broker_server: str = None, broker_topic: str = None, storage_host: str = None, storage_user: str = None, storage_password: str = None, storage_db: str = None, sites: str = None) -> None:
